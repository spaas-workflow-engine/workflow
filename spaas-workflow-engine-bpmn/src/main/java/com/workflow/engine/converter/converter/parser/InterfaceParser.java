        ...
        try {
            while (!readyWithInterface && xtr.hasNext()) {
                ...
                if (xtr.isStartElement() && ELEMENT_OPERATION.equals(xtr.getLocalName())) {
                    ...
                    if (operation != null && StrUtil.isNotEmpty(inMessageRef)) {
                    ...
                    if (operation != null && StrUtil.isNotEmpty(outMessageRef)) {
                    ...
                    if (operation != null && StrUtil.isNotEmpty(operation.getImplementationRef())) {
