...
public class ValuedDataObjectXMLConverter extends BaseBpmnXMLConverter {
    ...
    protected BaseElement convertXMLToElement(XMLStreamReader xtr, BpmnModel model) throws Exception {
        ...
        if (StrUtil.isNotEmpty(structureRef) && structureRef.contains(":")) {
        ...
        if (dataObject != null) {
            ...
            if (valuesElement != null && !valuesElement.isEmpty()) {
                ...
                if (StrUtil.isNotEmpty(valueElement.getElementText())) {
    ...
    protected void writeAdditionalAttributes(BaseElement element, BpmnModel model, XMLStreamWriter xtw) throws Exception {
        ...
        if (dataObject.getItemSubjectRef() != null && StrUtil.isNotEmpty(dataObject.getItemSubjectRef().getStructureRef())) {
    ...
    protected boolean writeExtensionChildElements(BaseElement element, boolean didWriteExtensionStartElement, XMLStreamWriter xtw) throws Exception {
        ...
        if (StrUtil.isNotEmpty(dataObject.getId()) && dataObject.getValue() != null) {
