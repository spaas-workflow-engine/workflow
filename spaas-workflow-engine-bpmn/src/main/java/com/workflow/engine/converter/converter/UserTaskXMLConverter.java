...
import com.workflow.engine.converter.converter.util.CommaSplitter;
...
public class UserTaskXMLConverter extends BaseBpmnXMLConverter {
    ...
    protected BaseElement convertXMLToElement(XMLStreamReader xtr, BpmnModel model) throws Exception {
        ...
        if (StrUtil.isNotEmpty(BpmnXMLUtil.getAttributeValue(ATTRIBUTE_TASK_USER_CANDIDATEUSERS, xtr))) {
        ...
        if (StrUtil.isNotEmpty(BpmnXMLUtil.getAttributeValue(ATTRIBUTE_TASK_USER_CANDIDATEGROUPS, xtr))) {
        ...
        if (StrUtil.isNotEmpty(BpmnXMLUtil.getAttributeValue(ATTRIBUTE_TASK_USER_SKIP_EXPRESSION, xtr))) {
    ...
    protected void writeAdditionalAttributes(BaseElement element, BpmnModel model, XMLStreamWriter xtw) throws Exception {
        ...
        if (StrUtil.isNotEmpty(userTask.getExtensionId())) {
    ...
    public static class HumanPerformerParser extends BaseChildElementParser {
        ...
        public void parseChildElement(XMLStreamReader xtr, BaseElement parentElement, BpmnModel model) throws Exception {
            ...
            if (StrUtil.isNotEmpty(resourceElement) && ELEMENT_RESOURCE_ASSIGNMENT.equals(resourceElement)) {
                String expression = XMLStreamReaderUtil.moveDown(xtr);
                if (StrUtil.isNotEmpty(expression) && ELEMENT_FORMAL_EXPRESSION.equals(expression)) {
    ...
    public static class PotentialOwnerParser extends BaseChildElementParser {
        ...
        public void parseChildElement(XMLStreamReader xtr, BaseElement parentElement, BpmnModel model) throws Exception {
            ...
            } else if (StrUtil.isNotEmpty(resourceElement) && ELEMENT_RESOURCE_REF.equals(resourceElement)) {
