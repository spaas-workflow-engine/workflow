...
public class BpmnModel {
    ...
    public void addDefinitionsAttribute(ExtensionAttribute attribute) {
        if (attribute != null && StrUtil.isNotEmpty(attribute.getName())) {
    ...
    public Process getProcess(String poolRef) {
        for (Process process : processes) {
            ...
            for (Pool pool : pools) {
                if (StrUtil.isNotEmpty(pool.getProcessRef()) && pool.getProcessRef().equalsIgnoreCase(process.getId())) {
    ...
    public void addMessageFlow(MessageFlow messageFlow) {
        if (messageFlow != null && StrUtil.isNotEmpty(messageFlow.getId())) {
    ...
    public void addMessage(Message message) {
        if (message != null && StrUtil.isNotEmpty(message.getId())) {
    ...
    public void addError(String errorRef, String errorCode) {
        if (StrUtil.isNotEmpty(errorRef)) {
    ...
    public void addEscalation(String escalationRef, String escalationCode, String name) {
        if (StrUtil.isNotEmpty(escalationRef)) {
    ...
    public void addEscalation(Escalation escalation) {
        if (StrUtil.isNotEmpty(escalation.getEscalationCode())) {
